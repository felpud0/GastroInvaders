...
/**
   \file Pantalla.h
   \brief  La biblioteca pantalla es un wrapper de la biblioteca SDL 2.0. Permite realizar programas interactivos que usan gráficos sin necesidad de conocer los detalles de la visualización gráfica ni de la programación dirigida por eventos.
 ...
 <br/>}
<br/><br/>Copyright © 2018 by Juan A. Sánchez Laguna, Fernando Jiménez Barrionuevo and Gracia Sánchez Carpena
<br/><br/>Permission to use, copy, modify, and distribute this software and its documentation under the terms of the GNU General Public License is hereby granted. No representations are made about
